...
** cost - стоимость(количество) циклов для выполнения команды //
** возможно достаточно будет count
** car_reg - регистр.
** 0 регистр - номер чемпиона, вызвавшего данный процесс
...
** ** map[3] - если клетка == 1, за последние Х циклов тут
...
int					key_managment(int ch, int speed);
