...
**
** nabr - номер каретки, используется только для дебагинга, отслеживать в нужном
**** порядке отрабатывают процессы или нет.
...
/*
** VM_comands - команды ВМ и все вспомогательные ф-ции
*/
